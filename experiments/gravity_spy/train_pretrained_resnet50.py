...
from ml.model.ResNet50 import ResNet50_pretrained3Channel
...
trainer = Trainer(DATASET_PATH, METADATA_PATH, OUTPUT, loss="focal", epochs=40, batch_size=64, lr=0.01,
                  weighted_loss=True, model_class=ResNet50_pretrained3Channel, dataset=WaveFormDatasetMerged3Channel,
