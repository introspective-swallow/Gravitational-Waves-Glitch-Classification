...
from ml.model.vit_b_16 import vit_b_16_pretrained3Channel
...
#                   weighted_loss=True, model_class=vit_b_16_pretrained3Channel, dataset=WaveFormDatasetMerged3Channel,
