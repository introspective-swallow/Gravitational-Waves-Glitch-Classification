...
from ml.model.ResNet18 import ResNet18_pretrained
from ml.data.dataset_GS import WaveFormDatasetMerged, get_metadata
...
OUTPUT = Path("/kaggle/working/transfer_learning")

trainer = Trainer(DATASET_PATH, METADATA_PATH, OUTPUT, loss="focal", epochs=40, batch_size=64, lr=0.001,
                  weighted_loss=True, model_class=ResNet18_pretrained, dataset=WaveFormDatasetMerged,
